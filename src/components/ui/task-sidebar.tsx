	...
	const renderTaskCard = (task: Task, isCompleted = false) => (
		<ContextMenu key={task.id}>
			<ContextMenuTrigger asChild>
				<div
					className={cn('p-3 bg-card border border-border rounded-lg hover:shadow-sm transition-all duration-200 cursor-pointer group', isCompleted && 'opacity-70', isDraggable && !isCompleted && 'hover:border-border/80')}
